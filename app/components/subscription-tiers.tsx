...
import { Check, Flower2, Gift, Sparkles, MapPin } from 'lucide-react'
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 animate-on-scroll">
          <h1 className="font-deco text-4xl sm:text-5xl lg:text-6xl mb-6">
            Blooms by <span className="text-accent">Anemone</span>
          </h1>
          ...
          {/* ZIP Code Checker */}
          <div className="bg-card/50 backdrop-blur-sm rounded-lg p-6 max-w-md mx-auto mb-8">
            <div className="flex items-center space-x-2 mb-2">
              <MapPin className="h-4 w-4 text-accent" />
              <span className="font-caps text-sm">Check Delivery Availability</span>
            </div>
            ...
            {deliveryAvailable !== null && (
              <div className={`text-sm mt-2 ${deliveryAvailable ? 'text-green-500' : 'text-red-500'}`}>
                {deliveryAvailable 
            ...
            return (
              ...
              >
                ...
                <div className="text-center mb-6">
                  ...
                  <h3 className="font-deco text-2xl mb-2">{subscription.name}</h3>
                  <div className="font-caps text-accent mb-2">{subscription.price}</div>
        ...
        <div className="text-center animate-on-scroll">
          <div className="bg-accent/5 rounded-lg p-8 max-w-4xl mx-auto">
            <h3 className="font-caps text-xl text-accent mb-4">Subscription Benefits</h3>
