...
import { MapPin, ExternalLink } from 'lucide-solid'

export default function KoniVenues() {
  let sectionRef: HTMLElement | undefined

  createEffect(() => {
    if (!sectionRef) return; // Ensure sectionRef is defined after mount
      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 animate-on-scroll">
          <h2 class="font-deco text-3xl sm:text-4xl lg:text-5xl mb-6">
            Featured <span class="text-accent">Venues</span>
          </h2>
            ...
            >
              <div class="relative aspect-video">
                ...
                <div class="absolute top-4 right-4">
                  <span class="bg-accent text-accent-foreground px-2 py-1 rounded text-xs font-caps">
                    {venue.type}
                  </span>
                </div>
              </div>
              ...
              <div class="p-6">
                <div class="flex items-start justify-between mb-3">
                  <h3 class="font-caps text-lg">{venue.name}</h3>
                  <ExternalLink class="h-4 w-4 text-accent opacity-0 group-hover:opacity-100 transition-opacity" />
                </div>
        ...
        <div class="mt-16 animate-on-scroll">
          <div class="bg-accent/5 rounded-lg p-8 text-center">
            <h3 class="font-caps text-xl text-accent mb-6">Additional Venue Partners</h3>
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 text-sm text-muted-foreground">
