import { createSignal, createEffect, useRef } from 'solid-js'
      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 animate-on-scroll">
          <h2 class="font-deco text-3xl sm:text-4xl lg:text-5xl mb-6">
            Subscription <span class="text-accent">Gallery</span>
          </h2>
        ...
        <div class="flex justify-center mb-12 animate-on-scroll">
          <div class="flex items-center space-x-4 bg-card/50 backdrop-blur-sm rounded-lg p-2">
            <Button
              variant="ghost"
              size="icon"
            ...
            <div class="flex space-x-2">
              {categories.map((category, index) => (
                <button
                  ...
                  class={`px-4 py-2 rounded-md text-sm font-caps transition-colors ${
        ...
        <div class="text-center animate-on-scroll">
          <div class="bg-accent/5 rounded-lg p-8 max-w-2xl mx-auto">
            <h3 class="font-caps text-xl text-accent mb-4">
