...
import { UserCheck, Palette, Truck, Heart } from 'lucide-solid'
      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            return (
              ...
              >
                ...
                <div class="bg-card/50 backdrop-blur-sm rounded-lg p-6 hover:glow-accent transition-all duration-300">
                  ...
                  <h3 class="font-caps text-lg mb-4">{step.title}</h3>
        ...
        <div class="mt-16 animate-on-scroll">
          <div class="bg-accent/5 rounded-lg p-8 max-w-4xl mx-auto">
            <h3 class="font-caps text-xl text-accent mb-6 text-center">Frequently Asked Questions</h3>
            <div class="grid md:grid-cols-2 gap-6 text-sm">
              <div>
                <strong>Can I pause my subscription?</strong>
                <p class="text-muted-foreground mt-1">Yes, pause anytime with 48-hour notice before your next delivery.</p>
              </div>
              <div>
                <strong>What if I'm not satisfied?</strong>
                <p class="text-muted-foreground mt-1">We guarantee fresh, beautiful arrangements or we'll make it right.</p>
              </div>
              <div>
                <strong>Do you deliver on weekends?</strong>
                <p class="text-muted-foreground mt-1">Yes, we offer flexible delivery scheduling throughout the week.</p>
              </div>
              <div>
                <strong>Can I gift a subscription?</strong>
                <p class="text-muted-foreground mt-1">Absolutely! Perfect for housewarmings, birthdays, or just because.</p>
              </div>
            </div>
          </div>
        </div>
